...
use AppBundle\Form\FacilityType;
...
class FacilityController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('AppBundle:Facility')->findAll();
     ...
     *
     * @Route("/", name="facility_create")
     * @Method("POST")
     * @Template("AppBundle:Facility:new.html.twig")
     */
    public function createAction(Request $request)
    {
        ...
        if ($form->isValid()) {
            ...
            return $this->redirect($this->generateUrl('facility_show', array('id' => $entity->getId())));
        }
    ...
    private function createCreateForm(Facility $entity)
    {
        $form = $this->createForm(new FacilityType(), $entity, array(
            'action' => $this->generateUrl('facility_create'),
            'method' => 'POST',
        ));
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('AppBundle:Facility')->find($id);
    ...
    */
    ...
    {
        $form = $this->createForm(new FacilityType(), $entity, array(
            'action' => $this->generateUrl('facility_update', array('id' => $entity->getId())),
            'method' => 'PUT',
        ));
     ...
     *
     * @Route("/{id}", name="facility_update")
     * @Method("PUT")
     * @Template("AppBundle:Facility:edit.html.twig")
     */
    ...
    private function createDeleteForm($id)
    {
        return $this->createFormBuilder()
            ->setAction($this->generateUrl('facility_delete', array('id' => $id)))
            ->setMethod('DELETE')
