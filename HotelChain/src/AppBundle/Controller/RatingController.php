...
class RatingController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('AppBundle:Rating')->findAll();
     ...
     * @Method("POST")
     * @Template("AppBundle:Rating:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('AppBundle:Rating')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("AppBundle:Rating:edit.html.twig")
     */
