...
class RoomController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('AppBundle:Room')->findAll();
     ...
     * @Method("POST")
     * @Template("AppBundle:Room:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('AppBundle:Room')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("AppBundle:Room:edit.html.twig")
     */
